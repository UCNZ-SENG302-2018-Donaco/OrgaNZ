Feature: Does PATCH /client/ work?
  Scenario: Update a non-existant client
    When I update client 5 using { "middleName": "New" }
  ...
  Scenario: Update a client using invalid json
    ...
    When I update client 1 using notvalidjson
    Then the result is bad request

  Scenario: Update a client without an etag
    Given there is a test client
    When I update client 1 using { "middleName": "New" }
  ...
  Scenario: Update a client replacing all the data
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using {"firstName": "Fred", "middleName": "Bob", "lastName": "Smith", "preferredName": "Joe", "currentAddress": "123 Fake St"}
    Then the result is ok

  Scenario: Update a client with a null value
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "firstName": null }
    Then the result is bad request

  Scenario: Update the uid field
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "uid": 500 }
    Then the result is ok
  ...
  Scenario: Update the region
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "region": "CANTERBURY" }
    Then the result is ok
  ...
  Scenario: Update to an invalid region
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "region": "NOTAREGION" }
    Then the result is bad request

  Scenario: Update blood type
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "bloodType": "O_NEG" }
    Then the result is ok
  ...
  Scenario: Update gender and genderIdentity
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "gender": "MALE", "genderIdentity": "FEMALE" }
    Then the result is ok
  ...
  Scenario: Update height and weight
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "weight": 50, "height": 180 }
    Then the result is ok
  ...
  Scenario: Update dates
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "dateOfBirth": "1987-01-01", "dateOfDeath": "1997-01-01" }
    Then the result is ok
  ...
  Scenario: Update to future
    Given there is a test client
    Given I have an etag from client 1
    When I update client 1 using { "dateOfBirth": "3000-01-01" }
    Then the result is bad request