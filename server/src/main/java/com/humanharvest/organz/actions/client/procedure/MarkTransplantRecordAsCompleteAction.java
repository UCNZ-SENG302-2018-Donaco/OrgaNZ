 ...
 */
public class MarkTransplantRecordAsCompleteAction extends ClientAction {
     ...
     */
    MarkTransplantRecordAsCompleteAction(TransplantRecord record, ClientManager manager)
