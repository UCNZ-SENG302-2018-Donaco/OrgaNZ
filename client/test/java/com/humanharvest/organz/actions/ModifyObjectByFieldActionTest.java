...
public class ModifyObjectByFieldActionTest extends BaseTest {
    ...
    public void ModifyStringValidTest() throws Exception {
        ...
        ModifyObjectByFieldAction action = new ModifyObjectByFieldAction(testItem, "setString", testItem.getString(),
                "newVal");
    ...
    public void ModifyPrimitiveIntSetIntegerValidTest() throws Exception {
        SettableItem testItem = new SettableItem();
        testItem.setAnInt(1);
        ModifyObjectByFieldAction action = new ModifyObjectByFieldAction(testItem, "setAnInt", testItem.getAnInt(),
                new Integer(2));
        invoker.execute(action);
        assertEquals(2, testItem.getAnInt());
    }
    ...
    public void ModifyObjectFromPrimitiveValidTest() throws Exception {
        ...
        ModifyObjectByFieldAction action = new ModifyObjectByFieldAction(testItem, "setAnInt", testItem.getInteger(),
                2);
        invoker.execute(action);
        assertEquals(2, testItem.getAnInt());
    }
