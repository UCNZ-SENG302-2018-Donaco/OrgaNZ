...
public class DurationFormatterTest {
    ...
    public void getDurationFormattedXHoursYMinutesSeconds1() {
        ...
        assertEquals("0 hours 0 seconds", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds1a() {
        Duration duration = Duration.ofSeconds(1);
        assertEquals("0 hours 1 second", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds2() {
        Duration duration = Duration.ofSeconds(20);
        assertEquals("0 hours 20 seconds", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds3() {
        Duration duration = Duration.ofSeconds(60);
        assertEquals("0 hours 1 minute", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }
    ...
    public void getDurationFormattedXHoursYMinutesSeconds5() {
        ...
        assertEquals("0 hours 3 minutes", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds6() {
        Duration duration = Duration.ofHours(1);
        assertEquals("1 hour 0 seconds", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds7() {
        Duration duration = Duration.ofHours(1).plusMinutes(5);
        assertEquals("1 hour 5 minutes", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds8() {
        Duration duration = Duration.ofHours(3);
        assertEquals("3 hours 0 seconds", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }

    @Test
    public void getDurationFormattedXHoursYMinutesSeconds9() {
        Duration duration = Duration.ofHours(5000);
        assertEquals("5000 hours 0 seconds", getFormattedDuration(duration, Format.XHoursYMinutesSeconds));
    }
